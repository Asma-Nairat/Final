...
public void initialize(URL url, ResourceBundle rb) {
    // 1. إضافة بيانات وهمية للقائمة (لاحقاً ستكون من قاعدة البيانات)
    tenantData.add(new Tenant("Jatin Khatri", "jatin@gmail.com", "9876543210", "Student", "123/E open-air theatre, NITH, Hamirpur, 123456"));
    tenantData.add(new Tenant("Mohd. Uvesh", "uv@gmail.com", "4564564564", "Professor", "abc, xyd society, qwe road, wer city, rty state, 1"));
    tenantData.add(new Tenant("Rahul Singh", "rahul@gmail.com", "1231231231", "Businessman", "13A Gol street, James Road, Maharashtra, 327898"));
